import { Component, useCallback, createRef, memo } from 'react';
...
// import {PaperProvider, PaperContext } from '../Paper/lib/paperContext';
...
*/
  ...
  fetch_info = async (obj = {}) => {
    ...
    try {
      ...
      if(display_console || false) console.error(`[Views] request error`,e)
    }// catch
