  ...
  // location customized for alight/controllers/getData/alias_maker.js
  ...
  const testAlias = async function(tObj)
  {
    try {
      ...
      console.error(chalk.red("[testAlias]"),"an error has occured",e);
    }
  ...
  const setDefaultAlias = async function (items) {
    try {
      ...
      console.error(chalk.red("[set default alias]"),"an error has occured",e);
    }
  }// setDefaultAlias
