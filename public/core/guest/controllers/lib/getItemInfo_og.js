  ...
  const getItemInfo = async function(req, res)
  {
    ...
    let info_table = '#__arc_item_data' ;
      ...
      for(let l = 0; l < rows.length; l++)
      {
        ...
        present_data_ids.push(rows[l]['_id']);
        ...
        let prep_pair_obj = await getPairObject(rows[l], display_data, item_data.user_id);//preps a pair request using ancestor object
