...
const {verifyToken} = require('../configuration/signToken');
const SITE_SERVER = require('./utils/keys').SITE_SERVER;

const app = express();
const server = http.createServer(app);
const io = (os.hostname().includes("sunzao")) ? socketio(server,{ path: '/narrator' }) :  socketio(server) ;
// const PORT = process.env.port || 3001;
const SERVER_PORT = typeof SITE_SERVER != "undefined" && SITE_SERVER == "beta" ? 3005 : 3003;
const PORT = (os.hostname().includes("sunzao")) ? SERVER_PORT : 3001;
