...
const display_console = false;
  ...
  const removeSomething = function(targ,char,repl)
  {
    ...
    */
    ...
    if(display_console || false) console.log(chalk.yellow("[removeSomething] multi"),curVal);
    ...
    if(char == " "){
      ...
      curVal = curVal.trim();
      if(display_console || false) console.log(chalk.yellow("[removeSomething] trim"),curVal);
    }//if

    if(repl != undefined && repl != ""){
      let replacer = new RegExp(char,'g');
      curVal = curVal.replace(replacer,repl);
      if(display_console || false) console.log(chalk.yellow("[removeSomething] repl"),curVal);
    }

    if(display_console || false) console.log(chalk.yellow("[removeSomething] final"),curVal);
    return curVal;
  };//end removeSomething
