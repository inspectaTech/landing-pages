  ...
  try {
    ...
    if(display_console || false) console.log(chalk.yellow('[check_make_category] accessed'));
    if(display_console || false) console.log(chalk.magenta('[check_make_image] user'),user);
    if(display_console || false) console.log(chalk.blue('[check_make_image] image'),image);

    // see if it has an image id
    let requested_image;
    let has_image_item = (typeof user[user.method].image_id != "undefined") ? true: false;
    if(display_console || false) console.log(chalk.yellow("[check_make_image] has_image_item = "), has_image_item);
    ...
    if(rtn && exists(requested_image)){
      if(display_console || false) console.log(chalk.green('[check_make_image] requested_image'),requested_image);
    ...
    if(!exists(requested_image)){
      ...
      if(display_console || false) console.log(chalk.magenta('[check_make_image] no requested_image was found'));
      ...
      if(display_console || false) console.log(chalk.green('[check_make_image] newItem newly saved'),newItem);
      ...
      if(display_console || false) console.log(chalk.green('[check_make_image] requested_image newly saved'),update_obj);
      return update_obj;
    ...
    if(display_console || false) console.log(chalk.red("[check_make_image] an error occured"),e);
  }
